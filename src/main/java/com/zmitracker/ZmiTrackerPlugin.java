...
public class ZmiTrackerPlugin extends Plugin
{
    ...
    // Ticks after a craft animation during which inventory rune gains are counted.
    // Bank withdrawals don't trigger the animation so they are ignored.
    ...
    public void onItemContainerChanged(ItemContainerChanged event)
    {
        ...
        // Only count gains
cat > src/main/java/com/zmitracker/ZmiTrackerPlugin.java << 'EOF'
package com.zmitracker;
...
public class ZmiTrackerPlugin extends Plugin
{
    ...
    public void onItemContainerChanged(ItemContainerChanged event)
    {
        ...
        // Only count gains within the crafting animation window
